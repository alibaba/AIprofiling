...
class _ObjectProxyMethods(object): # pragma: no cover
...
class _ObjectProxyMetaType(type): # pragma: no cover
...
class ObjectProxy(with_metaclass(_ObjectProxyMetaType)):  # pragma: no cover
...
class CallableObjectProxy(ObjectProxy): # pragma: no cover
...
class PartialCallableObjectProxy(ObjectProxy): # pragma: no cover
...
class BoundFunctionWrapper(_FunctionWrapperBase): # pragma: no cover
