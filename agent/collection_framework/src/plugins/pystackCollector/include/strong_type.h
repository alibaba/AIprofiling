...
namespace std {
template <typename T, typename Tag, typename ... M>
struct hash<pyki::strong::type<T, Tag, M...>>
  : std::conditional_t<
    std::is_base_of<
      pyki::strong::hashable::modifier<
        pyki::strong::type<T, Tag, M...>
      >,
      pyki::strong::type<T, Tag, M...>
    >::value,
    hash<T>,
    std::false_type>
{
  using type = pyki::strong::type<T, Tag, M...>;
  decltype(auto)
  operator()(
    const pyki::strong::hashable::modifier<type>& t)
  const
...
template <typename T, typename Tag, typename ... M>
struct is_arithmetic<pyki::strong::type<T, Tag, M...>>
  : is_base_of<pyki::strong::arithmetic::modifier<pyki::strong::type<T, Tag, M...>>,
               pyki::strong::type<T, Tag, M...>>
{
};
...
struct formatter<pyki::strong::type<T, Tag, M...>, Char,
                 std::enable_if_t<
                     std::is_base_of<
                         pyki::strong::formattable::modifier<
                             pyki::strong::type<T, Tag, M...>
                             >,
                         pyki::strong::type<T, Tag, M...>
                         >::value
    ...
    : formatter<T>
{
  ...
  constexpr
  decltype(auto)
  format(const pyki::strong::formattable::modifier<type>& t, FormatContext& fc)
